...
from hedgehogTransformer.hedgehogT import HedgehogTransformer  # Adjust import path as needed
import pickle
...
model = HedgehogTransformer(dim=512, depth=6, heads=8, dim_head=64, mlp_dim=2048, vocab_size=vocab_size)
